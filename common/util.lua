...
-- is a value an number
---@nodiscard
---@param x any value
---@return boolean is_number if the number is an number
...
---@return number sign (-1 for < 0, 1 otherwise)
function util.sign(x)
    return util.trinary(x < 0, -1, 1)
end

-- round a number to an number
---@nodiscard
...
---@nodiscard
---@param length number history length
...
---@nodiscard
---@param target_timing number minimum amount of milliseconds to wait for
---@param last_update number millisecond time of last update
---@return number time_now
--- EVENT_CONSUMER: this function consumes events
